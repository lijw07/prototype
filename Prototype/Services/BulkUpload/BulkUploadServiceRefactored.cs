...
public class BulkUploadServiceRefactored : IBulkUploadService
{
    private readonly SentinelContext _context;
    private readonly ILogger<BulkUploadServiceRefactored> _logger;
    ...
    public BulkUploadServiceRefactored(
        SentinelContext context,
        ILogger<BulkUploadServiceRefactored> logger,
