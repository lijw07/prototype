...
public class MicrosoftSqlServerUserPasswordStrategy : IDatabaseTypeSpecificValidator
{
    public async Task<(bool success, string message)> TestConnectionAsync(ApplicationRequestDto dto)
    {
        try
        {
            var builder = new SqlConnectionStringBuilder
            {
                ...
                UserID = dto.ConnectionSource.Username,
                Password = dto.ConnectionSource.Password,
